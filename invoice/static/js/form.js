$(document).ready(function () {
    ...
    var addItem = function () {
        ...
        template += '<td ><input type="text" data-id="' + counter +
        '" class="form-control form-control-plaintext alt_quantity"></td>'
        template += '<td ><input type="text" data-id="' + counter +
            '" class="form-control form-control-plaintext quantity"></td>'
        template += '<td ><input type="text" data-id="' + counter +
        ...
        template +=
            ...
            template += '<td ><input type="text" data-id="' + counter +
            '" class="form-control form-control-plaintext amount"></td>'
